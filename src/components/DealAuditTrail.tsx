...
const EVENT_CONFIG: Record<string, { label: string; icon: typeof FileText; color: string }> = {
  deal_created: { label: 'Deal Created (Draft)', icon: Plus, color: 'text-muted-foreground' },
  ...
  deal_approved: { label: 'Deal Approved', icon: CheckCircle2, color: 'text-success' },
  deal_funded: { label: 'Deal Funded', icon: DollarSign, color: 'text-success' },
  deal_overdue: { label: 'Deal Marked Overdue', icon: AlertTriangle, color: 'text-destructive' },
  deal_closed: { label: 'Deal Closed', icon: CheckCircle2, color: 'text-muted-foreground' },
