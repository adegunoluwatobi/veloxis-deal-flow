...
const ROW2 = [
  ...
  },
  {
    ...
    kicker: "Legally",
    kickerLabel: "SECURED",
    title: "IPU- or LC-backed transactions",
    body: "Your buyer either signs an Irrevocable Payment Undertaking or arranges a confirmed letter of credit before any funds leave Veloxis. Every transaction is legally binding and enforceable.",
    kickerSize: "text-[22px]",
  },
  {
    strip: "#0f766e",
