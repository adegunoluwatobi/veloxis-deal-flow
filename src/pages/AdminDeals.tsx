...
export default function AdminDeals() {
  ...
  const QUICK_STATUSES: (DealStatus | 'all')[] = ['all', 'under_review', 'ready_for_final_approval' as DealStatus, 'rejection_pending_approval' as DealStatus, 'docs_requested', 'approved', 'funded_active', 'overdue'];
