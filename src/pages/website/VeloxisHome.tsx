...
const faqs: FaqItem[] = [
  ...
  { q: "What is commercial factoring?", a: "Commercial factoring is export trade finance where a Factor purchases the trade receivable created by your shipment. Veloxis is not a lender — we buy the right to your future payment at a discount, so you receive liquidity immediately and we collect from your buyer's bank at maturity. Every transaction is protected by our Triple-Lock framework: independent physical verification of the commodity, a formal Assignment of Proceeds under English law backed by a Letter of Credit or Irrevocable Payment Undertaking under UCP 600, and controlled settlement through Virtual IBANs and escrow accounts." },
  ...
  { q: "Is Veloxis regulated?", a: "Veloxis operates strictly as a business-to-business entity that purchases commercial assets (trade receivables) rather than providing consumer or retail credit. Commercial factoring of B2B receivables sits outside the FCA regulatory perimeter and is not a regulated activity under the UK Financial Services and Markets Act 2000. Veloxis Ltd (Company number 15663333) is registered in England and Wales and operates under English law. All transactions — including the Assignment of Proceeds, Letter of Credit or Irrevocable Payment Undertaking under UCP 600 — are governed by English law. We follow UK AML and KYC standards in partnership with our in-country origination partners." },
    ...
    <div className="min-h-screen" style={{ scrollBehavior: "smooth", background: C.deepEmerald }}>
      ...
      <section id="partners" className="py-16 px-8" style={{ background: C.deepEmerald }}>
        <div className="mx-auto max-w-[960px]">
          ...
          <p className="text-[14px] text-white/45 max-w-[480px] mx-auto text-center mb-10">Veloxis works with trusted local partners including finance companies, trade associations, and origination networks. Currently active across Nigeria, Ghana, and Kenya, with new corridors opening each quarter.</p>
      ...
      {/* ── CORRIDOR STATEMENT (replaces testimonials) ── */}
      <section className="py-16 px-8" style={{ background: C.darkTeal }}>
        <div className="mx-auto max-w-[760px] text-center">
          <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#1ABC9C] mb-3">The corridor we serve</p>
      ...
      <footer className="py-12 px-8" style={{ background: C.darkBg, borderTop: "0.5px solid rgba(26,188,156,0.08)" }}>
        <div className="mx-auto max-w-[960px] grid grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-8 mb-8">
          <div>
            ...
            <p className="text-[13px] text-white/35 leading-[1.6] mb-3">UK-based commercial factoring for cross-border export trade finance. Advancing 80% of export invoice value within 24 hours for commodity exporters worldwide shipping to UK and EU buyers.</p>
