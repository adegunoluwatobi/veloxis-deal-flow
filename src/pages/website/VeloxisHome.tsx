...
const faqs: FaqItem[] = [
  ...
  { q: "What is invoice discounting?", a: "Invoice discounting is a form of trade finance where a financier advances cash against an unpaid invoice. Unlike a loan, it does not add debt to your balance sheet. Veloxis purchases your receivable at a discount: you receive cash now, and we collect from your buyer at maturity. Before any funds are released, the buyer either signs an Irrevocable Payment Undertaking directly with Veloxis or provides a confirmed letter of credit." },
