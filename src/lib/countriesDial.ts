// Comprehensive list of countries with ISO codes, dial codes and flag emoji.
...
export const DIAL_COUNTRIES: DialCountry[] = [
  ...
  { name: "Jamaica", iso: "JM", dial: "+1", flag: "🇯🇲" },
  ...
  { name: "Macao", iso: "MO", dial: "+853", flag: "🇲🇴" },
  ...
  { name: "Trinidad and Tobago", iso: "TT", dial: "+1", flag: "🇹🇹" },
